...
Oefening 3.6.2 (p.128), voor W2, W5, W6, en W8. Ah, maar dit was nabeschouwing al. Mannekes toch, ... 

Oef. 3.6.6 (p.129): als stelsel geschreven (willekeurige lineair combinatie van die 3 vectoren gelijkstellen aan gegeven vector). Stel in matrix, proberen oplossen, ik kwam strijdig stelsel uit, dus antwoord: Nee. 
...
Oefening 2. Maak oefening 3.6.5 (p. 129). 

Oefening 3. Maak oefening 3.6.7 (p. 129). 

Oefening 4. Maak oefening 3.6.9 (p. 129). 

Oefening 5. Maak oefening 3.6.13 (p. 130). 

Oefening 6. Maak oefening 3.6.28 (p. 132). 
